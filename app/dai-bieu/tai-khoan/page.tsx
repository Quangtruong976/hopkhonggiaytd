...
export default function DaiBieuTaiKhoanPage() {
  ...
  async function loadProfile() {
    ...
    try {
      ...
      /*
       * Email đăng nhập lấy từ Auth là chính xác nhất
       */
  ...
  async function handleChangeEmail() {
    ...
    if (!email) {
      setFormError("Vui lòng nhập tên đăng nhập mới.");
      return;
    }
    ...
    try {
      ...
      /*
       * Supabase có thể yêu cầu xác nhận email mới.
       */

      setSuccessMessage(
        "Bạn đã đổi tên đăng nhập thành công. Nếu hệ thống yêu cầu xác nhận email mới, vui lòng kiểm tra hộp thư."
      );

      /*
       * Cập nhật email trong profile nếu bảng profiles
       * cho phép người dùng cập nhật email.
       */
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-0.5 text-sm text-emerald-100">
                Cổng thông tin dành cho đại biểu
              </p>
          ...
          <div className="space-y-5">
            ...
            <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              <button
                ...
                className="rounded-xl border border-emerald-200 bg-emerald-50 px-5 py-3 text-sm font-semibold text-emerald-700 shadow-sm transition hover:border-emerald-300 hover:bg-emerald-100"
              >
                {showEditForm
                  ? "Đóng phần thay đổi"
              ...
              <button
                ...
                className="rounded-xl border border-red-200 bg-white px-5 py-3 text-sm font-semibold text-red-600 shadow-sm transition hover:border-red-300 hover:bg-red-50"
              >
                Đăng xuất
              </button>
              ...
              <section className="overflow-hidden rounded-2xl border border-emerald-200 bg-white shadow-sm">
                ...
                <div className="border-b border-emerald-100 bg-emerald-50/50 px-6 py-5">
                  ...
                  <p className="mt-1 text-xs text-slate-500">
                    ...
                    Họ tên và vai trò Đại biểu không thay đổi tại đây.
                  </p>
